...
from agents.agent import run_autonomous_agent
from agents.registry import DEFAULT_MODEL, get_project_path
...
def main() -> None:
    ...
    try:
        if args.agent_type:
            ...
            from agents.orchestrator import run_parallel_orchestrator
